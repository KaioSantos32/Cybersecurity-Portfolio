...
![Search failed login attempts](images/3_1_search_failed_log_in_attempts.png)
...
![Specific date filter](images/3_2_filter_specific_date.png)
...
![Search for a specific department](images/3_3_search_specific_department.png)
...
![Filter with IN operator](images/3_4_filter_with_in_operator.png)
